...
Source0  : https://lttng.org/files/lttng-tools/lttng-tools-2.12.15.tar.bz2
Source1  : https://lttng.org/files/lttng-tools/lttng-tools-2.12.15.tar.bz2.asc
...
%prep
%setup -q -n lttng-tools-2.12.15
cd %{_builddir}/lttng-tools-2.12.15
pushd ..
cp -a lttng-tools-2.12.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711724810
