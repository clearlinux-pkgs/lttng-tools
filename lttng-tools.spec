...
Source0  : https://lttng.org/files/lttng-tools/lttng-tools-2.12.16.tar.bz2
Source1  : https://lttng.org/files/lttng-tools/lttng-tools-2.12.16.tar.bz2.asc
...
%setup -q -n lttng-tools-2.12.16
cd %{_builddir}/lttng-tools-2.12.16
pushd ..
cp -a lttng-tools-2.12.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724377502
