...
BuildRequires : pkgconfig(lttng-ust-ctl)
...
%prep
%setup -q -n lttng-tools-2.13.11
cd %{_builddir}/lttng-tools-2.13.11
pushd ..
cp -a lttng-tools-2.13.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702921210
