...
Source0  : https://lttng.org/files/lttng-tools/lttng-tools-2.14.0.tar.bz2
Source1  : https://lttng.org/files/lttng-tools/lttng-tools-2.14.0.tar.bz2.asc
...
%setup -q -n lttng-tools-2.14.0
cd %{_builddir}/lttng-tools-2.14.0
pushd ..
cp -a lttng-tools-2.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751306980
...
/usr/include/lttng/event-rule/log4j2-logging.h
